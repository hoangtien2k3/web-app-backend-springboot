...
import com.hoangtien2k3.shopappbackend.constants.CommonConstant;
...
import static com.hoangtien2k3.shopappbackend.constants.CommonConstant.DATE_FORMAT_YM2;
...
public class DataUtil {
    ...
    public static Long safeToLong(Object obj1, Long defaultValue) {
        ...
        if (obj1 instanceof BigDecimal bigDecimal) {
            return bigDecimal.longValue();
        }
        if (obj1 instanceof BigInteger bigInteger) {
            return bigInteger.longValue();
        }
        if (obj1 instanceof Double v) {
            return v.longValue();
        }
        try {
            return Long.parseLong(obj1.toString());
        } catch (NumberFormatException e) {
            log.error("safeToLong error: ", e);
            return defaultValue;
        }
    }
